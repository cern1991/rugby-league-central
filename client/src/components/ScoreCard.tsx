...
export function ScoreCard({ game }: ScoreCardProps) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-xl bg-card border border-border/50 hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:shadow-primary/10">
      {/* Status Bar */}
      ...
      <div className="p-5 grid grid-cols-[1fr_auto_1fr] gap-4 items-center">
        ...
        <div className="flex flex-col items-center gap-3 text-center">
          <div className={cn("w-12 h-12 rounded-full flex items-center justify-center text-xs font-bold shadow-lg", game.homeTeam.logoColor)}>
            {game.homeTeam.abbreviation}
          </div>
          <div className="space-y-0.5">
            <span className="block text-sm font-bold tracking-tight">{game.homeTeam.abbreviation}</span>
        ...
        {/* Away Team */}
        <div className="flex flex-col items-center gap-3 text-center">
          <div className={cn("w-12 h-12 rounded-full flex items-center justify-center text-xs font-bold shadow-lg", game.awayTeam.logoColor)}>
            {game.awayTeam.abbreviation}
          </div>
          <div className="space-y-0.5">
            <span className="block text-sm font-bold tracking-tight">{game.awayTeam.abbreviation}</span>
