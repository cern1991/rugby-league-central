...
function buildCustomTeamFixtures(teamName: string, fixtures: CustomTeamFixture[], matchNumberOffset: number) {
...
const WIGAN_FIXTURES_2026 = (() => {
  ...
  const fixtures: CustomTeamFixture[] = [
  ...
  return buildCustomTeamFixtures("Wigan Warriors", fixtures, 1000);
})();
...
const WARRINGTON_FIXTURES_2026 = (() => {
  ...
  return buildCustomTeamFixtures("Warrington Wolves", fixtures, 2000);
})();
